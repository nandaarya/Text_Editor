...
object TextEditorData {
    private val textEditorNames = arrayOf(
        "Adobe Dreamweaver",
        "Atom",
        "Bluefish",
        "Brackets",
    ...
    private val textEditorImages = intArrayOf(
    ...
    private val textEditorDetails = arrayOf(
        ...
        "Sublime Text is a shareware cross-platform source code editor originally created by Jon Skinner. It natively supports many programming languages and markup languages. Users can expand its functionality with plugins, typically community-built and maintained under free-software licenses. To facilitate plugins, Sublime Text features a Python API.",
